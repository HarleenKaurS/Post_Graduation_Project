...
$id=$_GET['updateid'];
$select= "SELECT * FROM categorytable where Category_id=$id";
...
if(isset($_POST['click']))
{
  $id = $_POST['t1'];
  $name = $_POST['t2'];
  $sql = "update categorytable set Category_id='$id',Categoryname='$name' where Category_id=$id";
    ...
    <section class="container my-2  w-50 text-dark p-2 border border-danger rounded-3">
      ...
      <form action="" method="post" class="row g-3 p-3" enctype="multipart/form-data">
        <div>  
          ...
          <input type="text" class="form-control" name="t1" id="validationDefault02" placeholder="id"  value="<?php echo  $row['Category_id']?>"  aria-label="First_name" aria-describedby="basic-addon1">
        </div>
        <div class="col-md-4 ">
          ...
          <input type="text" class="form-control" name="t2" placeholder="name"  value="<?php echo  $row['Categoryname']?>" aria-label="First_name" aria-describedby="basic-addon1" required>
        </div>
